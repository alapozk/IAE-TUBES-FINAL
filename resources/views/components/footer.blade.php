    ...
    <div class="max-w-7xl mx-auto px-6 py-12">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            ...
            <div class="space-y-4">
                ...
                <p class="text-sm text-gray-400">Platform pembelajaran daring terpadu untuk ekosistem pendidikan Indonesia.</p>
            ...
            <div>
                ...
                <ul class="space-y-2 text-sm">
                    ...
                    <li><a href="#" class="hover:text-blue-500 transition-colors">Fitur</a></li>
                    <li><a href="#" class="hover:text-blue-500 transition-colors">Harga</a></li>
            ...
            <div>
                ...
                <ul class="space-y-2 text-sm">
                    ...
                    <li><a href="#" class="hover:text-blue-500 transition-colors">Dokumentasi</a></li>
                    <li><a href="#" class="hover:text-blue-500 transition-colors">Kontak</a></li>
            ...
            <div>
                ...
                <ul class="space-y-2 text-sm">
                    ...
                    <li><a href="#" class="hover:text-blue-500 transition-colors">Lisensi</a></li>
                </ul>
            </div>
        </div>
        ...
        <div class="border-t border-gray-700 pt-8 flex flex-col md:flex-row justify-between items-center">
            <p class="text-sm text-gray-400">
                &copy; {{ date('Y') }} <span class="font-semibold text-white">EduConnect LMS</span>. Dibuat dengan ❤️ menggunakan Laravel & Tailwind CSS.
            </p>
            <div class="flex space-x-6 mt-4 md:mt-0 text-sm">
                <a href="#" class="hover:text-blue-500 transition-colors">Status</a>
                <a href="#" class="hover:text-blue-500 transition-colors">Changelog</a>
                <a href="#" class="hover:text-blue-500 transition-colors">Sitemap</a>
            </div>
        </div>
    </div>
</footer>
